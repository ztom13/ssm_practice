        ...
        <section class="content"> <!-- .box-body -->
            <div class="box box-primary">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button type="button" class="btn bg-olive btn-xs"
                                                    onclick='location.href="${pageContext.request.contextPath}/pages/order-list.jsp"'>
                                                订单
                                            </button>
                                            <button type="button" class="btn bg-olive btn-xs"
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            总共${pageInfo.pages}页，共${pageBean.total}条数据。 每页
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li><a href="javascript:gotoPage(${pageInfo.firstPage})" aria-label="Previous">首页</a></li>
                            <li><a href="javascript:gotoPage(${pageInfo.prePage})">上一页</a></li>

                            <c:forEach begin="${pageInfo.firstPage}" end="${pageInfo.lastPage}" var="p">
                                <li class="${pageInfo.pageNum==p?'active':''}">
                                    <a href="javascript:gotoPage(${p})">${p}</a>
                                </li>
                            </c:forEach>

                            <li><a href="javascript:gotoPage(${pageInfo.nextPage})">下一页</a></li>
                            <li><a href="javascript:gotoPage(${pageInfo.lastPage})" aria-label="Next">尾页</a></li>
                        </ul>
                    </div>
...
<script type="text/javascript">
    function gotoPage(num) {
        ...
        if (num != null) {
            if (num >= 1 && num <=${pageInfo.pages})
                location.href = "${pageContext.request.contextPath}/product/findAll?pageNum=" + num + "&pageSize="+pageSize;
        }
    }
    $(function () {
